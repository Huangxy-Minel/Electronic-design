...
#define LD_PLL_11			(uint8)((CLK_IN/2)-1)
#define LD_PLL_MP3_19		0x0f
#define LD_PLL_MP3_1B		0x18
#define LD_PLL_MP3_1D   	(uint8)(((90*((LD_PLL_11)+1))/(CLK_IN))-1)

#define LD_PLL_ASR_19 		(uint8)(CLK_IN*32/(LD_PLL_11+1) - 0.51)
...
#define CODE_KAIDENGD	0
#define CODE_GUANDENG	1
#define CODE_FANGJIANA	3
