...
{ 	
  ...
  FSMC_NORSRAMTimingInitTypeDef  readWriteTiming; 
	...
	RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOA|RCC_AHB1Periph_GPIOD|RCC_AHB1Periph_GPIOE|RCC_AHB1Periph_GPIOF|RCC_AHB1Periph_GPIOG, ENABLE);//使能PD,PE,PF,PG时钟  
  RCC_AHB3PeriphClockCmd(RCC_AHB3Periph_FSMC,ENABLE);//使能FSMC时钟  
	
 
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_13;//PD13 推挽输出,控制背光
  ...
  GPIO_Init(GPIOE, &GPIO_InitStructure);//初始化  
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_14;//PF14,FSMC_A8
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF;//复用输出
  GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;//推挽输出
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;//100MHz
  GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_UP;//上拉
  ...
  GPIO_PinAFConfig(GPIOF,GPIO_PinSource14,GPIO_AF_FSMC);//PF12,AF12
...
//*p:字符串起始地址	
//mode 0覆盖 1费覆盖
void LCD_ShowStr(u16 x,u16 y,u16 width,u16 height,u8 size,u8 *p,u8 mode )
{         
	u8 x0=x;
	width+=x;
	height+=y;
