...
void LED_Init(void)
{
    ...
    HAL_GPIO_Init(GPIOF,&GPIO_Initure);     //初始化GPIOB.0和GPIOB.1	
    HAL_GPIO_WritePin(GPIOF,GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_3|GPIO_PIN_4,GPIO_PIN_SET);	//PB1置0
    ...
    HAL_GPIO_WritePin(GPIOI,GPIO_PIN_9|GPIO_PIN_10|GPIO_PIN_11,GPIO_PIN_SET);	//PB1置0
    ...
    HAL_GPIO_WritePin(GPIOE,GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_6,GPIO_PIN_SET);	//PB1置0
    ...
    HAL_GPIO_WritePin(GPIOC,GPIO_PIN_13,GPIO_PIN_SET);	//PB1置0
}
